...
const startLogoutTimer = function() {
  ...
  // Call the tick() function immediately first, and then the timer every second
  tick();
...
// Rounding Decimals
  ...
  // JavaScript perfroms boxing autmatically
  // when rounding decimals. So, it converts
  // the number to a string. This is why we
  // manually convert back to a number! 
...
console.log(48384302483342043823408394839483204n);
console.log(BigInt(48384302));

// Operations
console.log(10000n + 10000n);
console.log(875658732655487236548623084562380560238n * 
  875895873498759834759834759834795873n);

const huge = 20764812481583478216457n;
const num = 23;
...
// console.log(new Date('Mar 22 2022 12:37:45'));
// console.log(new Date('December 24, 2015'));
// console.log(new Date(account1.movementsDates[0]));

// // Note that month values are zero-based
